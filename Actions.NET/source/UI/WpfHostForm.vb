...
Namespace UI
    ...
    ''' <summary> A Form (window) that hosts WPF content. </summary>
     ''' <remarks> 
     ''' <para>
     ''' A <see cref="System.Windows.Forms.Form"/>, which is intended
     ''' to show a WPF UserControl as the host application's child window.
     ''' </para>
     ''' <para>
    ...
    Public Class WpfHostForm
        ...
        #Region "Event Handlers"
            ...
            Private Sub WpfHostForm_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
                '
                ...
                '        System.Diagnostics.Debug.Fail("WpfHostForm_FormClosing(): Save settings failed!")
                '    End Try
                'End If
            End Sub
